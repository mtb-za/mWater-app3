  ...
  describe('GeoJSON', function() {
    return it('returns a proper polygon', function() {
      ...
      return assert.deepEqual(json, {
        type: "Polygon",
        coordinates: [[[10, 20], [13, 20], [13, 23], [10, 23]]]
      });
    });
  });
...
},{"../app/js/ItemTracker":7}],3:[function(require,module,exports){
(function() {
  var assert,
...
(function() {
  exports.LatLngBoundsToGeoJSON = function(bounds) {
    return {
      type: 'Polygon',
      coordinates: [[[bounds.getSouth(), bounds.getWest()], [bounds.getNorth(), bounds.getWest()], [bounds.getNorth(), bounds.getEast()], [bounds.getSouth(), bounds.getEast()]]]
    };
  };
