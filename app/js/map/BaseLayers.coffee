...
exports.createOSMLayer = (onReady, onError) ->
  ...
  return new offlineMap.OfflineLayer(mapquestUrl, {maxZoom: 18, attribution: mapquestAttrib, onReady:onReady, onError: onError})
...
exports.createSatelliteLayer = (onReady, onError) ->
  ...
  return new offlineMap.OfflineLayer(mapquestUrl, {maxZoom: 18, attribution: mapquestAttrib, subdomains: subDomains, onReady:onReady, onError: onError, storeName:"satelliteOfflineStore"})