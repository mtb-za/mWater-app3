...
module.exports = function(grunt) {
  ...
  grunt.registerTask('copy-app', ['copy:apphtml', 'replace:html_js_timestamps', 'copy:appimages', 'copy:libbootstrapfonts', 'copy:esricssimages', 'copy:leafletimages', 'copy:zocialfonts']);
